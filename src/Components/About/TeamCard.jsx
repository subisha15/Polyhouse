  ...
  return (
    ...
    >
      <div className="flex  flex-col items-center justify-center m-6">
        <p className="text-orange-500 font-semibold mb-2">Our Team</p>
        <h1 className="text-2xl md:text-5xl font-bold leading-snug mb-2">
          Meet Our Dedicated Team
        </h1>
      </div>

      <div className="flex  justify-center p-2 gap-4 items-center m-10">
        {teamImages.map((image, index) => (
          ...
          >
            ...
            <div className="absolute z-0 top-1/2 left-1/2 w-36 h-36 rounded-full bg-orange-500 opacity-100 blur-[12px] animate-[blob-bounce_5s_infinite_ease] transform -translate-x-1/2 -translate-y-1/2"></div>
